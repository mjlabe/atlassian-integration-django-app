"""
Django settings for AtlassianIntegration project.
...
ROOT_URLCONF = 'AtlassianIntegration.urls'
...
WSGI_APPLICATION = 'AtlassianIntegration.wsgi.application'
...
STATIC_URL = '/static/'
if DEBUG:
    STATIC_ROOT = os.path.join(BASE_DIR, 'AtlassianApp', 'static')
else:
